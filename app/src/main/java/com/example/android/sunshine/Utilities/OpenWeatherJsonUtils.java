...
public final class OpenWeatherJsonUtils {
     ...
     */
    public static String[] getSimpleWeatherStringsFromJson(Context context,
    ...
    /**
     * Parse the JSON and convert it into ContentValues
     * that can be inserted into our database.
     *
