...
/**
 * Class for handling date conversations that are useful
 * for sunshine
 */
public final class SunshineDateUtils {
     ...
     *          since the epoch (January 01, 1970, 12:00 Midnight UTC)
     ...
     *                                 we must convert the given date
     *                (in UTC timezone) to the date in the local timezone.
     * Ths function performs that conversion using the TimeZone offset.
     *
     * @param utcDate The UTC datetime to convert to a local datetime,
     *               in milliseconds.
     * @return The local date (the UTC datetime - the TimeZone offset)
     *                 in milliseconds.
     */
